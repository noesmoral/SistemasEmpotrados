...
TEDROOMBool prac6_2::EDROOMIsComponentFinished() {
	...
	return ( Client1.EDROOMIsComponentFinished() && Client2.EDROOMIsComponentFinished() && Client3.EDROOMIsComponentFinished() && Client4.EDROOMIsComponentFinished() && Client5.EDROOMIsComponentFinished() && Client6.EDROOMIsComponentFinished() && Client7.EDROOMIsComponentFinished() && Client8.EDROOMIsComponentFinished() && SuperServer.EDROOMIsComponentFinished() && CEDROOMComponent::EDROOMIsComponentFinished());
