...
TEDROOMSignal CEDROOMSystemCommSAP::C1MainActor_PAvoidObstaclesSysCtrl__C4AvoidObstacles_PAvoidObstaclesSysCtrl(TEDROOMSignal signalOut){
	...
	switch(signalOut){
		...
		case( Vehicle::SConfigAO):	 signalIn=CAAvoidObstacles::SConfigAO; break;
 
		case( Vehicle::SStart):	 signalIn=CAAvoidObstacles::SStart; break;
...
TEDROOMSignal CEDROOMSystemCommSAP::C4AvoidObstacles_PAvoidObstaclesSysCtrl__C1MainActor_PAvoidObstaclesSysCtrl(TEDROOMSignal signalOut){
	...
	switch(signalOut){
		...
		case( CAAvoidObstacles::SObstacleDetected):	 signalIn=Vehicle::SObstacleDetected; break;
 
		case( CAAvoidObstacles::SConfigError):	 signalIn=Vehicle::SConfigError; break;
 
		case( CAAvoidObstacles::SConfigOK):	 signalIn=Vehicle::SConfigOK; break;
...
void CEDROOMSystemCommSAP::RegisterInterfaces(){
	...
	m_localCommSAP.RegisterInterface(1, mp_comp4->AvoidObstaclesSysCtrl, mp_comp4);
